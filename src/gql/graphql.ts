...
export type CartCreateMutation = {
	createOrder?: {
		...
		orderItems: Array<{
			...
			quantity: number;
			total: number;
			product?: { name: string; price: number; id: string; images: Array<{ url: string }> } | null;
		}>;
	} | null;
};
...
export type CardOrderItemFragment = {
	id: string;
	quantity: number;
	total: number;
	product?: { name: string; price: number; id: string; images: Array<{ url: string }> } | null;
...
export type CartOrderProductFragment = {
	name: string;
	price: number;
	id: string;
...
export type ProductGetByNameQuery = {
	products: Array<{
		id: string;
		name: string;
		description: string;
...
export type ProductGetByPageQuery = {
	products: Array<{
		id: string;
		name: string;
		description: string;
...
export type ProductGetColorSizeVariantsByIdQuery = {
	product?: { variants: Array<{ id: string; name: string } | {}> } | null;
};
...
export const CartOrderProductFragmentDoc = new TypedDocumentString(
  ...
  images {
    ...
    `,
	{ fragmentName: "CartOrderProduct" },
) as unknown as TypedDocumentString<CartOrderProductFragment, unknown>;
export const CardOrderItemFragmentDoc = new TypedDocumentString(
  ...
  images {
	...
	{ fragmentName: "CardOrderItem" },
) as unknown as TypedDocumentString<CardOrderItemFragment, unknown>;
...
export const CartSetProductQuantityDocument = new TypedDocumentString(`
  ...
  updateOrderItem(where: {id: $itemId}, data: {quantity: $quantity}) {
    ...
    `) as unknown as TypedDocumentString<
	CartSetProductQuantityMutation,
...
export const ProductGetColorSizeVariantsByIdDocument = new TypedDocumentString(`
  ...
  name
	...
	ProductGetColorSizeVariantsByIdQuery,
	ProductGetColorSizeVariantsByIdQueryVariables
>;
...
export const ProductUpdateRatingDocument = new TypedDocumentString(`
    mutation ProductUpdateRating($id: ID!, $rating: Int!) {
  updateProduct(where: {id: $id}, data: {averageRating: $rating}) {
    id
  }
}
    `) as unknown as TypedDocumentString<
...
export const ReviewGetByProductIdDocument = new TypedDocumentString(`
  ...
  reviews(where: {product: {id: $productId}}) {
    ...
    `) as unknown as TypedDocumentString<
	ReviewGetByProductIdQuery,
	ReviewGetByProductIdQueryVariables
>;
