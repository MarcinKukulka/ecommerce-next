...
export type CartCreateMutation = { createOrder?: { id: string, orderItems: Array<{ id: string, quantity: number, total: number, product?: { name: string, price: number, id: string, images: Array<{ url: string }> } | null }> } | null };
...
export type CartGetByIdQuery = { order?: { id: string, orderItems: Array<{ id: string, quantity: number, total: number, product?: { name: string, price: number, id: string, images: Array<{ url: string }> } | null }> } | null };

export type CartFragment = { id: string, orderItems: Array<{ id: string, quantity: number, total: number, product?: { name: string, price: number, id: string, images: Array<{ url: string }> } | null }> };

export type CardOrderItemFragment = { id: string, quantity: number, total: number, product?: { name: string, price: number, id: string, images: Array<{ url: string }> } | null };

export type CartOrderProductFragment = { name: string, price: number, id: string, images: Array<{ url: string }> };
...
export type CategoryFragment = { name: string, slug: string, description?: string | null };
...
export type ProductsGetByCollectionSlugQuery = { collections: Array<{ products: Array<{ id: string, name: string, description: string, price: number, categories: Array<{ name: string }>, images: Array<{ url: string }> }> }> };
...
export type ProductGetByPageQuery = { products: Array<{ id: string, name: string, description: string, price: number, categories: Array<{ name: string }>, images: Array<{ url: string }> }> };

export type ProductGetColorSizeVariantsByIdQueryVariables = Exact<{
  id: Scalars['ID']['input'];
}>;


export type ProductGetColorSizeVariantsByIdQuery = { product?: { variants: Array<{ id: string, name: string } | {}> } | null };
...
export type ReviewGetByProductIdQuery = { reviews: Array<{ rating: number }> };

export type VariantFragment = { id: string, name: string };
...
export const CartOrderProductFragmentDoc = new TypedDocumentString(`
  ...
  images {
    ...
    `, {"fragmentName":"CartOrderProduct"}) as unknown as TypedDocumentString<CartOrderProductFragment, unknown>;
export const CardOrderItemFragmentDoc = new TypedDocumentString(`
...
}`, {"fragmentName":"CardOrderItem"}) as unknown as TypedDocumentString<CardOrderItemFragment, unknown>;
...
export const ProductGetColorSizeVariantsByIdDocument = new TypedDocumentString(`
  ...
  id
  name
}`) as unknown as TypedDocumentString<ProductGetColorSizeVariantsByIdQuery, ProductGetColorSizeVariantsByIdQueryVariables>;
