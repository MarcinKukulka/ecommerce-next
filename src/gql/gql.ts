...
export function graphql(
	source: "mutation CartAddProduct($productId: ID!, $orderId: ID!, $total: Int!) {\n  createOrderItem(\n    data: {product: {connect: {id: $productId}}, order: {connect: {id: $orderId}}, quantity: 1, total: $total}\n  ) {\n    id\n  }\n}",
 ...
 */
export function graphql(
	source: "fragment CardOrderItem on OrderItem {\n  id\n  quantity\n  total\n  product {\n    ...CartOrderProduct\n  }\n}",
): typeof import("./graphql").CardOrderItemFragmentDoc;
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(
	source: "fragment CartOrderProduct on Product {\n  name\n  price\n  id\n  images {\n    url\n  }\n}",
 ...
 */
export function graphql(
	source: "mutation CartSetProductQuantity($itemId: ID!, $quantity: Int!) {\n  updateOrderItem(where: {id: $itemId}, data: {quantity: $quantity}) {\n    id\n  }\n}",
 ...
 */
export function graphql(
	source: "query ProductsGetByCategorySlug($slug: String!, $skip: Int, $first: Int) {\n  categories(where: {slug: $slug}) {\n    products(skip: $skip, first: $first) {\n      ...Product\n    }\n  }\n}",
): typeof import("./graphql").ProductsGetByCategorySlugDocument;
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(
	source: "query ProductsGetByCollectionSlug($slug: String!, $skip: Int, $first: Int) {\n  collections(where: {slug: $slug}) {\n    products(skip: $skip, first: $first) {\n      ...Product\n    }\n  }\n}",
 ...
 */
export function graphql(
	source: "query ProductGetByName($name: String!) {\n  products(where: {name_contains: $name}) {\n    ...Product\n  }\n}",
): typeof import("./graphql").ProductGetByNameDocument;
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(
	source: "query ProductGetByPage($skip: Int!, $first: Int!, $orderBy: ProductOrderByInput) {\n  products(skip: $skip, first: $first, orderBy: $orderBy) {\n    ...Product\n  }\n}",
): typeof import("./graphql").ProductGetByPageDocument;
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(
	source: "query ProductGetColorSizeVariantsById($id: ID!) {\n  product(where: {id: $id}) {\n    variants {\n      ... on ProductSizeColorVariant {\n        ...Variant\n      }\n    }\n  }\n}",
 ...
 */
export function graphql(
	source: "mutation ProductUpdateRating($id: ID!, $rating: Int!) {\n  updateProduct(where: {id: $id}, data: {averageRating: $rating}) {\n    id\n  }\n}",
): typeof import("./graphql").ProductUpdateRatingDocument;
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(
	source: "query ReviewGetByProductId($productId: ID!) {\n  reviews(where: {product: {id: $productId}}) {\n    rating\n  }\n}",
): typeof import("./graphql").ReviewGetByProductIdDocument;
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(
	source: "fragment Variant on ProductSizeColorVariant {\n  id\n  name\n}",
